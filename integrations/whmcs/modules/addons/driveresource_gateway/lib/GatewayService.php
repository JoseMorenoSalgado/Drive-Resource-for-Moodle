...
final class GatewayService
{
    ...
    public function authorizeUpload(object $service, array $payload): array
    {
        ...
        try {
            ...
            throw new GatewayException('Bunny Stream could not create the video resource.', 502);
        }
    ...
    public function completeUpload(object $service, array $payload): array
    {
        ...
        try {
            ...
            throw new GatewayException('Bunny Stream could not verify the uploaded video.', 502);
        }
    ...
    public function reconcileAsset(object $service, string $siteUrl, array $payload): array
    {
        ...
        try {
            ...
            throw new GatewayException('The restored video no longer exists in Bunny Stream.', 404);
        }
