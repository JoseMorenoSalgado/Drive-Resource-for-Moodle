...
grep -q "'version' => '0.4.0'" integrations/whmcs/modules/addons/driveresource_gateway/driveresource_gateway.php     || fail "WHMCS addon version 0.4.0 is missing."
...
grep -q "Generar nueva key" integrations/whmcs/modules/servers/driveresource/lib/ClientPortal.php     || fail "Client token rotation UI is missing."
grep -q "Validar conexión" integrations/whmcs/modules/servers/driveresource/lib/ClientPortal.php     || fail "Client connection validation UI is missing."
grep -q "Videos del servicio" integrations/whmcs/modules/servers/driveresource/lib/ClientPortal.php     || fail "Client video library UI is missing."
