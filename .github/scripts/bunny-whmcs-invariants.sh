...
grep -q "'version' => '0.5.3'" integrations/whmcs/modules/addons/driveresource_gateway/driveresource_gateway.php     || fail "WHMCS addon version 0.5.3 is missing."
...
grep -q "driveresource_gateway_ensure_collection_schema" integrations/whmcs/modules/addons/driveresource_gateway/driveresource_gateway.php     || fail "0.5.3 virtual-classroom schema migration is missing."
grep -q "video_collection_id" integrations/whmcs/modules/addons/driveresource_gateway/driveresource_gateway.php     || fail "Per-service provider collection id is missing."
grep -q "video_collection_name" integrations/whmcs/modules/addons/driveresource_gateway/driveresource_gateway.php     || fail "Per-service provider collection name is missing."
grep -q "function ensureVirtualClassroom" integrations/whmcs/modules/addons/driveresource_gateway/lib/GatewayService.php     || fail "Virtual classroom allocator is missing."
grep -q "createCollection" integrations/whmcs/modules/addons/driveresource_gateway/lib/BunnyClient.php     || fail "Provider collection creation support is missing."
grep -q "setVideoCollection" integrations/whmcs/modules/addons/driveresource_gateway/lib/BunnyClient.php     || fail "Provider video collection assignment is missing."
grep -q "OrganizeVideoCollection" integrations/whmcs/modules/servers/driveresource/driveresource.php     || fail "Existing-service virtual classroom organizer is missing."
