...
$string['setting_whmcsgatewayheading'] = 'Conexión de Elearning Stream (WHMCS)';
...
$string['setting_whmcsgatewayurl_desc'] = 'URL HTTPS del módulo Drive Resource Media Gateway, por ejemplo https://billing.ejemplo.com/modules/addons/driveresource_gateway. No ingrese solamente la URL principal de WHMCS.';
...
$string['task_synctransferusage'] = 'Sincronizar transferencia de Elearning Stream con WHMCS';
...
$string['whmcsgatewaynotconfigured'] = 'Elearning Stream no está configurado en Moodle. Faltan estos datos: {$a}. Configúrelos en Administración del sitio > Plugins > Módulos de actividad > Drive Resource.';
