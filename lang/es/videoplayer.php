...
$string['bunnyplaybackphasepending'] = 'El video quedó vinculado al proveedor. La reproducción segura de Bunny se habilita en la siguiente fase del proveedor.';
...
$string['bunnyuploadintro'] = 'El video se sube directamente desde el navegador a la plataforma de video administrada. Las claves API de Bunny nunca se almacenan en Moodle.';
...
$string['bunnyuploadrequired'] = 'Sube el video antes de guardar este recurso Bunny Stream.';
...
$string['setting_whmcsgatewayheading_desc'] = 'Las credenciales API de Bunny Stream permanecen exclusivamente en WHMCS. Moodle solo guarda la identidad del servicio WHMCS y un token limitado a ese servicio.';
...
$string['setting_whmcsservicetoken_desc'] = 'Token limitado al servicio generado por la pasarela de WHMCS. No es una clave API de Bunny.';
...
$string['sourcebunnystream'] = 'Bunny Stream (subida directa)';
...
$string['videoplayer:uploadvideo'] = 'Subir videos mediante la pasarela multimedia administrada';
