...
$string['modulename_help'] = 'Use this activity to publish videos through Elearning Stream and protected resources from Google Drive or Moodle local storage.';
...
$string['setting_whmcsgatewayheading'] = 'Elearning Stream connection (WHMCS)';
$string['setting_whmcsgatewayheading_desc'] = 'Elearning Stream provider credentials remain exclusively in WHMCS. Moodle stores only the WHMCS service identity and service-scoped gateway token.';
$string['setting_whmcsgatewayurl'] = 'WHMCS gateway URL';
$string['setting_whmcsgatewayurl_desc'] = 'HTTPS URL of the Drive Resource Media Gateway addon, for example https://billing.example.com/modules/addons/driveresource_gateway. Do not enter only the WHMCS home URL.';
...
$string['setting_whmcsservicetoken_desc'] = 'Service-scoped token generated by the WHMCS Drive Resource gateway. This is not a video-provider credential.';
...
$string['whmcsgatewaynotconfigured'] = 'Elearning Stream is not configured in Moodle. Missing settings: {$a}. Configure them under Site administration > Plugins > Activity modules > Drive Resource.';
