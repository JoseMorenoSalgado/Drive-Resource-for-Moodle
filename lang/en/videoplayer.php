...
$string['sourcebunnystream'] = 'Bunny Stream (direct upload)';
$string['bunnyuploadlabel'] = 'Video upload';
$string['bunnyuploadintro'] = 'The video is uploaded directly from your browser to the managed video platform. Bunny API keys are never stored in Moodle.';
...
$string['bunnyuploadrequired'] = 'Upload the video before saving this Bunny Stream resource.';
...
$string['bunnyplaybackphasepending'] = 'The provider upload is linked. Secure Bunny playback is enabled in the next provider phase.';
$string['whmcsgatewaynotconfigured'] = 'The WHMCS media gateway is not configured.';
$string['whmcsgatewayhttpsrequired'] = 'The WHMCS media gateway must use a secure HTTPS URL.';
$string['whmcsgatewayinvalidresponse'] = 'WHMCS returned an invalid upload authorisation.';
$string['whmcsgatewayinvaliduploadendpoint'] = 'WHMCS returned an untrusted video upload endpoint.';
$string['whmcsgatewayrequestfailed'] = 'The WHMCS media gateway could not process the request.';
$string['whmcsgatewayremoteerror'] = 'The media gateway rejected the request: {$a}';
$string['setting_whmcsgatewayheading'] = 'WHMCS media gateway';
$string['setting_whmcsgatewayheading_desc'] = 'Bunny Stream API credentials remain exclusively in WHMCS. Moodle stores only the WHMCS service identity and service-scoped gateway token.';
$string['setting_whmcsgatewayurl'] = 'WHMCS gateway URL';
$string['setting_whmcsgatewayurl_desc'] = 'HTTPS base URL of the WHMCS installation that hosts the Drive Resource Media Gateway addon.';
$string['setting_whmcsserviceid'] = 'WHMCS service ID';
$string['setting_whmcsserviceid_desc'] = 'The active WHMCS service that owns this Moodle installation and its Drive Resource quota.';
$string['setting_whmcsservicetoken'] = 'WHMCS service token';
$string['setting_whmcsservicetoken_desc'] = 'Service-scoped token generated by the WHMCS Drive Resource gateway. This is not a Bunny API key.';
$string['setting_whmcstimeout'] = 'WHMCS gateway timeout';
$string['setting_whmcstimeout_desc'] = 'Server-to-server request timeout in seconds (5–60).';
$string['videoplayer:uploadvideo'] = 'Upload videos through the managed media gateway';
