...
$string['videoerrorcodec'] = 'The protected video reached your browser, but its codec is not supported for HTML5 playback. For maximum compatibility, use MP4 with H.264/AVC video and AAC audio.';
$string['videoerrorgeneric'] = 'The video could not be played. Reload the activity or ask the site administrator to check the protected streaming diagnostics.';
$string['videoerrornetwork'] = 'Drive Resource could not obtain a playable byte stream from Google Drive. Verify that the file is shared so it can be opened with the link, then try again.';
